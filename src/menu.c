...
code Menu_t menu_list[20] = {
    ...
    {PA_PID_MENU_ID, PA_RUN_MENU_ID, PA_CON_MENU_ID, PA_PID_SET_MENU_ID, PARAM_SET_MENU_ID, PA_PID_MENU},
    ...
    {PA_PID_SET_MENU_ID, NULL_MENU_ID, NULL_MENU_ID, PA_PID_MENU_ID, NULL_MENU_ID, PA_PID_SET_MENU},
    /* 四级菜单 */
